% Load the trained NARXS (NARX in simulation configuration) model with required dataset
load("../Existing_Models/NARXS_model.mat");
...
% Simulate the output using the identified NARXS model for Trip 1
Trip_1_estimated_y = sim(NARXS, Identification_dataset);
...
Trip_2_estimated_y = sim(NARXS, Validation_dataset_1);
...
Trip_3_estimated_y = sim(NARXS, Validation_dataset_2);
...
Trip_4_estimated_y = sim(NARXS, Validation_dataset_3);
